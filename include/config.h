...
#define RADIO_TX                A0 /* TODO: specify your setup's Serial TX pin connected to the XBee module DIN pin */
#define RADIO_RX                A1 /* TODO: specify your setup's Serial RX pin connected to the XBee module DOUT pin */
